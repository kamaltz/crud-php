...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2024 at 07:28 AM
...
-- Error reading data for table grosir.barang: #2006 - MySQL server has gone away
...
<a href="db_sql.php?sql_query=SET+SQL_QUOTE_SHOW_CREATE+%3D+1&amp;show_query=1&amp;db=grosir"><span class="nowrap"><img src="themes/dot.gif" title="Edit" alt="Edit" class="icon ic_b_edit">&nbsp;Edit</span></a>    </p>
<p>
<code class="sql"><pre>
